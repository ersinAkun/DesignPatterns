...
public class Mediator {
    ...
    void mediatorDemo() {
        ...
        actor1.sendMessage("topic2", "topic 2 icin mesaj");
        actor1.sendMessage("topic3", "topic 3 icin mesaj");
        actor1.sendMessage("topic4", "topic 4 icin mesaj");

        actor2.sendMessage("topic1", "topic 2");
